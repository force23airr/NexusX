  ...
  const listings = [
    {
      ...
      baseUrl: "https://api.openai-proxy.com/v1", healthCheckUrl: "https://api.openai-proxy.com/health",
    ...
    },
    {
      ...
      listingType: "MODEL_INFERENCE" as const, status: "ACTIVE" as const,
      baseUrl: "https://api.anthropic-relay.com/v1", healthCheckUrl: "https://api.anthropic-relay.com/health",
    ...
    },
    {
      ...
      baseUrl: "https://api.deepl-connect.com/v2", healthCheckUrl: "https://api.deepl-connect.com/health",
    ...
    },
    {
      ...
      listingType: "REST_API" as const, status: "ACTIVE" as const,
      baseUrl: "https://api.textinsight.ai/v1", healthCheckUrl: "https://api.textinsight.ai/health",
    ...
    },
    {
      ...
      listingType: "REST_API" as const, status: "ACTIVE" as const,
      baseUrl: "https://api.visionai.dev/v1", healthCheckUrl: "https://api.visionai.dev/health",
    ...
    },
    {
      ...
      listingType: "REST_API" as const, status: "ACTIVE" as const,
      baseUrl: "https://api.embedco.io/v3", healthCheckUrl: "https://api.embedco.io/health",
    ...
    {
      id: ID.lstDataset, providerId: ID.providerDataVault, categoryId: ID.catSentiment,
      ...
      baseUrl: "https://data.datavault.io/v1/download",
