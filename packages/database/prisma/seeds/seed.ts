...
async function main() {
  ...
  const listings = [
    {
      ...
      sampleRequest: { messages: [{ role: "user", content: "Hello" }], model: "gpt-4-turbo" },
    ...
    },
    {
      ...
      sampleRequest: { messages: [{ role: "user", content: "Explain quantum computing" }], model: "claude-sonnet" },
      sampleResponse: { choices: [{ message: { role: "assistant", content: "Quantum computing uses qubits..." } }] },
    ...
    },
    {
      ...
      sampleRequest: { text: "Hello world", target_lang: "ES" },
      sampleResponse: { translations: [{ detected_source_language: "EN", text: "Hola mundo" }] },
    ...
    },
    {
      ...
      sampleRequest: { text: "This product is amazing!" },
      sampleResponse: { sentiment: "positive", confidence: 0.95, polarity: 0.87, subjectivity: 0.72 },
    ...
    },
    {
      ...
      sampleRequest: { image_url: "https://example.com/photo.jpg" },
      sampleResponse: { objects: [{ label: "person", confidence: 0.97, bbox: [10, 20, 200, 300] }], scene: "indoor_office" },
    ...
    },
    {
      ...
      sampleRequest: { text: "Hello world", model: "text-embedding-v3" },
      sampleResponse: { object: "embedding", data: [{ embedding: [0.1, -0.2, 0.3], index: 0 }] },
    ...
    },
    {
      ...
      sampleResponse: { dataset: "restaurant-reviews-v1", format: "csv", total_reviews: 500000 },
  ...
  for (const listing of listings) {
    await prisma.listing.upsert({
      where: { id: listing.id },
      update: {
        sampleRequest: listing.sampleRequest ?? undefined,
        sampleResponse: listing.sampleResponse ?? undefined,
      },
      create: listing,
    });
  }
