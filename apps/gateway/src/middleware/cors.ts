...
const EXPOSED_HEADERS = [
  ...
  "X-NexusX-Failure-Class",
  "X-NexusX-Retryable",
  "X-NexusX-Billing-Decision",
  "X-NexusX-Response-Hash",
  "X-NexusX-Receipt-Payload-Hash",
  "X-NexusX-Receipt-Signature",
  "X-NexusX-Receipt-Signer",
  "X-NexusX-Receipt-Signature-Alg",
